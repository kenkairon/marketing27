...
class LabelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create label" do
    assert_difference("Label.count") do
      post labels_url, params: { label: { contact: @label.contact, publication_id: @label.publication_id } }
    end
  ...
  test "should update label" do
    patch label_url(@label), params: { label: { contact: @label.contact, publication_id: @label.publication_id } }
